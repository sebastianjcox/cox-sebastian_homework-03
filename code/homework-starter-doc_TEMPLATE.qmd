...
Leaf Dry Weight & Specific Leaf Area: There is no correlation
(Pearson's r = 0.033) between the two variables.
**insert comparison 2 here**  
Root Weight and Total Weight: There is a strong positive correlation (Pearson's
r = 0.858) between the variables.
**insert comparison 3 here**
Shoot Weight and Root Weight: There is a moderately strong positive correlation 
(Pearson's r = 0.553) between the weights.
...
**response here**
Plants with larger biomass tend to have more range in biomass, whereas plants 
with smaller biomass have less range. Grindelia camporum has the highest 
biomass and Acmispon glaber has the lowest biomass
...
**response here**
Well-watered plants tend to have a higher biomass than drought-stressed ones.
This is consistent with biological knowledge on how plants use water to grow.
...
**response here**
Specimens with greater specific leaf area tend to have greater total. There 
appears to be a moderate positive correlation between the two.
biomass.
# Model construction
...
Out of the four models we have tried, the best model is the one that includes 
**specific leaf area, species, and water treatment (all three predictors).**
...
- SLA slope: **across drought treatments, and species, with each 1 unit**
**increase in SLA (mm^2/dry mass of leaf), we expect an increase in total mass**
**of -0.00025 which means with the estimate and standard error there is NO**
**EFFECT OF SLA ON TOTAL MASS**  
- well watered estimate: **Across species and SLA, well-watered plants tend to**
**be 0.12 ± 0.02g heavier than drought-stressed plants**    
